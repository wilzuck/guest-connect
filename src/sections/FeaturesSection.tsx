...
function getIcons(): ReactNode[] {
  return [
    ...
    <Icon key="2">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path d="M3 8h18v10a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V8Z" stroke="currentColor" strokeWidth="1.8" />
    ...
    <Icon key="3">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <path d="M3.6 9h16.8M3.6 15h16.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path
    ...
    <Icon key="4">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <path d="M8 17v-6m4 6V7m4 10v-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    </Icon>,
    <Icon key="5">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path d="M12 22a8 8 0 0 0 8-8V9A8 8 0 1 0 4 9v5a8 8 0 0 0 8 8Z" stroke="currentColor" strokeWidth="1.8" />
        <path d="M8 11v3m8-3v3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path d="M9 16c.7.7 1.7 1.1 3 1.1s2.3-.4 3-1.1" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    </Icon>,
  ];
}
...
const FEATURE_KEYS = [
  { title: "easyBookingTitle", desc: "easyBookingDesc" },
  { title: "verifiedTitle", desc: "verifiedDesc" },
  { title: "paymentsTitle", desc: "paymentsDesc" },
  { title: "availabilityTitle", desc: "availabilityDesc" },
  { title: "dashboardTitle", desc: "dashboardDesc" },
  { title: "supportTitle", desc: "supportDesc" },
] as const;

export async function FeaturesSection() {
  const t = await getTranslations("homeFeatures");
  const icons = getIcons();
  const features: Feature[] = FEATURE_KEYS.map((k, i) => ({
    title: t(k.title),
