  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      <Card className="p-6 shadow-none">
        <p className="text-sm font-semibold text-black">{isEdit ? "Modifier un service" : "Créer un service"}</p>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <label className="grid gap-2">
            ...
            <span className="text-xs text-zinc-500">Optionnel, utile pour filtres/URLs.</span>
          </label>
        </div>
        ...
        <label className="mt-5 flex items-center gap-3">
          ...
          />
          <span className="text-sm font-semibold text-black">Service actif</span>
