...
export function FavoriteButton({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "grid h-10 w-10 place-items-center cursor-pointer rounded-full  border-black/10 bg-white/90 backdrop-blur shadow-sm shadow-black/10 transition hover:bg-zinc-50 active:scale-[0.98] dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-black/40 dark:hover:bg-zinc-900",
        className,
      )}
    >
