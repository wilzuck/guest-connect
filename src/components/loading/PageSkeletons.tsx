    ...
    <div className="bg-zinc-50">
      <Container className="py-8 sm:py-10">
        <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
          <aside className="hidden rounded-3xl border border-black/10 bg-white p-4 lg:block">
...
export function AdminLoadingSkeleton() {
  return (
    <div className="grid h-[calc(100dvh-4rem)] min-h-[680px] grid-cols-1 bg-white lg:grid-cols-[256px_minmax(0,1fr)]">
      <aside className="hidden border-r border-[#E8E8EC] bg-[#F7F7F8] p-3 lg:block">
      ...
      <section className="min-w-0">
        <header className="flex h-16 items-center justify-between border-b border-[#E8E8EC] px-4 lg:px-6">
        ...
        <div className="mt-4 border-y border-[#E8E8EC]">
          <SkeletonBlock className="h-11 rounded-none" />
          {Array.from({ length: 9 }).map((_, index) => (
            <div key={index} className="grid grid-cols-[1.5fr_1fr_1fr_120px] gap-3 border-t border-[#EFEFF2] px-4 py-3">
