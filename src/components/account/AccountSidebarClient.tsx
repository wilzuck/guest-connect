              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-black text-white" : "text-zinc-700 hover:bg-zinc-50 hover:text-black",
                  )}
                >
                  <span className={cn("grid h-8 w-8 place-items-center rounded-xl", active ? "bg-white/10" : "bg-zinc-100")}>
                    {it.icon}
                  </span>
