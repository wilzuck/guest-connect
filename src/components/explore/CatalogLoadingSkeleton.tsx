    ...
    <div className="bg-white">
      <section className="border-b border-black/5 bg-white">
        <Container className="py-10 sm:py-14">
          ...
          <div className="mt-5 h-10 w-full max-w-xl rounded-2xl bg-zinc-100 sm:h-12" />
          <div className="mt-4 h-4 w-full max-w-2xl rounded-full bg-zinc-100" />
          <div className="mt-8 h-16 rounded-2xl bg-zinc-100" />
        </Container>
      </section>
      ...
      <section className="bg-white">
        <Container className="py-12 sm:py-14">
          <div className="flex gap-2 overflow-hidden">
            <div className="h-10 w-24 shrink-0 rounded-full bg-zinc-100" />
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="h-10 w-32 shrink-0 rounded-full bg-zinc-100" />
            ))}
          </div>
