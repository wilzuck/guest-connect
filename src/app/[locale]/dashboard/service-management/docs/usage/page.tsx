export default function Page() {
  return (
    <article className="max-w-3xl">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500 dark:text-white/80">Documentation</p>
      <h1 className="mt-3 text-2xl font-semibold tracking-tight">Utilisation de l’administration</h1>
