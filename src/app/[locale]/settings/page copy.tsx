        ...
        <div className="max-w-3xl">
          <div className="grid gap-10">
            ...
            <Card className="overflow-hidden border border-black/10 bg-white p-0 shadow-none">
              <Row
                title="Avatar"
                subtitle="JPG, PNG ou GIF (max 2 Mo)"
                right={
                  <div
          ...
          <Section title="Notifications">
            <Card className="border border-black/10 bg-white p-6 shadow-none">
              <p className="text-sm text-zinc-600">
                Emails, rappels de réservation et nouveautés.
              </p>
              <div className="mt-6 grid gap-3 text-sm">
                <Toggle defaultChecked label="Rappels de réservation" />
                <Toggle defaultChecked label="Alertes de prix" />
                <Toggle label="Nouveautés produit" />
              </div>
            </Card>
          </Section>
